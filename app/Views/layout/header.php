	...
	<div id="main-wrapper">
		<div class="nav-header">
			<a href="index.html" class="brand-logo">
				<img class="logo-abbr" src="<?= base_url('/E-perpus/e.png')?>" alt="" style="width: 70px; height: 50px;">
				<img class="brand-title" src="<?= base_url('/E-perpus/perpus.png')?>" alt="" style="margin-top: -2px; height: 25px; width: 100%;">
			</a>
							...
							<li class="nav-item dropdown header-profile">
								<a class="nav-link">
									<div class="header-info">
										<span>Hallo, <strong class="text-capitalize">
											<?php 
									...
									<?php }else{ ?>
										<img src="<?= base_url('/assets/images/profile/default_profile.jpeg')?>" width="20" alt=""/>
									<?php } ?>
								</a>
							</li>
						</ul>
