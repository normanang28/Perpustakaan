    ...
    <div class="card">
        <div class="card-body">
            <div class="basic-form">
                <form id="userForm" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate action="<?= base_url('E_Perpus/aksi_tambah_peminjaman')?>" method="post">
                  ...
                  <a href="<?= base_url('/E_Perpus/peminjaman')?>" type="button" class="btn btn-primary">Cancel</a></button>
