    ...
    <div class="card">
        <div class="card-body">
            <div class="basic-form">
                <form id="userForm" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate action="<?= base_url('E_Perpus/aksi_tambah')?>" method="post">

                    <div class="row">
                        <div class="mb-3 col-md-6">
                            <label class="form-label">Judul Buku<span style="color: red;">*</span></label>
                            <input type="text" id="judul_buku" name="judul_buku" 
                            class="form-control text-capitalize" placeholder="Judul Buku">
                        </div>
                        <div class="mb-3 col-md-6">
                            <label class="form-label">Jenis Buku<span style="color: red;">*</span></label>
                            <input type="text" id="jenis_buku" name="jenis_buku" 
                            class="form-control text-capitalize" placeholder="Jenis Buku">
                        </div>
                        <div class="mb-3 col-md-6">
