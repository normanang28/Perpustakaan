    ...
    <div class="container main">
        <div class="row">
            ...
            <div class="col-md-6 right">
                <div class="input-box">
                    <form method="post" action="<?= base_url('home/sign_in') ?>">
                     <header>
                         <h1>Welcome</h1>
                     </header>
                ...
                <div class="signin">
                    <span>Don't have an account? <a href="<?= base_url('Sign_Up')?>">Sign Up</a></span>
                </div>
            </div>  
        </div>
    </div>
...
.side-image{
    background-image: url("<?= base_url('login/sign_in.jpeg') ?>");
    background-position: center;
    background-size: cover;
    background-repeat: no-repeat;
